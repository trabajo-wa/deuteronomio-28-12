    ...
    return (
        <div className="bg-beige">
            ...
            <main className="flex flex-col gap-4">
                ...
                <QuestionsCard question={"¿Cómo debo almacenar el producto?"} answer={"Guarda el producto refrigerado. Una vez abierto, te recomendamos usarlo dentro de los 6 meses para garantizar la máxima efectividad de los ingredientes naturales."} />
            </main>
